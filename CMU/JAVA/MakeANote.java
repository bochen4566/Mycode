                ...
                case 1:
                    ...
                    do {
                        ...
                        switch (subchoice) {
                            // Create a Memo
                            case 1:
                                note = NoteCollection.createNote("Memo", name, body, from, to, "Simple");
                            ...
                            case 2:
                                    ...
                                    System.out.print("Enter who this is to: ");
                                    to = keyboard.nextLine();
                                    note = NoteCollection.createNote("TimedMemo", name, body, from, to, "Fancy");
                                    noteCollection.add(note);
                            ...
                            case 3:
                                    ...
                                    System.out.print("Enter who this is to: ");
                                    to = keyboard.nextLine();
                                    note = NoteCollection.createNote("PoliteTimedMemo", name, body, from, to, "Really");
                                    noteCollection.add(note);
